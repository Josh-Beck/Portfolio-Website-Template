...
export default function CoolButton(props) {
    return (
        <div className="pl-7 pt-3 text-md lg:text-lg xl:text-xl">
            <Link href={props.href} id="no-link" className="z-50 relative inline-flex items-center justify-start py-3 pr-12 overflow-hidden font-semibold primary-color-text transition-all duration-150 ease-in-out rounded-xl hover:pl-9 hover:pr-3 bg-opacity-0 group">
